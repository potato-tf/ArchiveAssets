...
//	self.SetMaxVisionRangeOverride(100)		// breaks pathfinding??
	...
	if ((round_number > 11 && round_number <= 13) && playerclass != 2)
	{
		...
		if (speedrandomizer == 8 && playerclass != 2)
		{
			...
			PopExtWeapons.GiveItem("ZedShotgun", self);
			PopExtUtil.AddAttributeToLoadout(self, "move speed penalty",0.85,-1)
	...
	if ((round_number > 13 && round_number <= 15) && playerclass != 2)
	{
		...
		if (speedrandomizer == 7)
		{
			...
			PopExtWeapons.GiveItem("ZedRanger", self);
			PopExtUtil.AddAttributeToLoadout(self, "move speed penalty",0.85,-1)
	...
	if ((round_number > 15 && round_number <= 19) && playerclass != 2)
	{
		...
		if ((speedrandomizer == 8 && speedrandomizer_2 > 6))
		{
			...
			PopExtWeapons.GiveItem("ZedPhlog", self);
	...
	if ((round_number > 18 && round_number <= 19) && playerclass != 2)
	{
		...
		//	PopExtWeapons.GiveItem("HopperMelee", self);
	...
	if (round_number > 19 && playerclass != 2)
	{
		...
		if ((speedrandomizer == 7 && speedrandomizer_2 > 6))
		{
			...
			PopExtUtil.GiveWearableItem(self, 9911, "models/player/items/heavy/heavy_wolf_chest.mdl")
			PopExtUtil.GiveWearableItem(self, 9911, "models/workshop/player/items/heavy/dec22_ol_reliable_style2/dec22_ol_reliable_style2.mdl")
			PopExtUtil.GiveWearableItem(self, 9911, "models/workshop/player/items/heavy/hwn2016_mad_mask/hwn2016_mad_mask.mdl")
			PopExtUtil.GiveWearableItem(self, 9911, "models/workshop/player/items/heavy/sbox2014_war_pants/sbox2014_war_pants.mdl")
			PopExtUtil.AddAttributeToLoadout(self, "dmg taken from blast increased",2.5,-1)
			PopExtUtil.AddAttributeToLoadout(self, "move speed penalty",0.85,-1)
			PopExtWeapons.GiveItem("ZedMinigun", self);
